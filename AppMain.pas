...
begin
  ...
  g_pLogMgr.Add('程序版本: 2018/09/15');
  g_pLogMgr.Add('程序网站: www.happym2.com ');
...
begin
  ...
  while DWORD(pTRBuf) < DWORD(pTREnd) do begin
    ...
    if dwStep >= SizeOf(TSvrCmdPack) then begin
      ...
      with pTRCmd^ do begin
        ...
        case Cmd of
          ...
          GM_SERVERUSERINDEX: begin
              if (SockID < USER_ARRAY_COUNT) then begin
